...
inline void ddsktx_get_sub(const ddsktx_texture_info* tc, ddsktx_sub_data* sub_data,
                 const void* file_data, int size,
                 int array_idx, int slice_face_idx, int mip_idx)
{
    ddsktx_assert(tc);
...
inline bool ddsktx_parse(ddsktx_texture_info* tc, const void* file_data, int size, ddsktx_error* err)
{
    ddsktx_assert(tc);
    ddsktx_assert(file_data);
    ddsktx_assert(size > 0);
...
inline const char* ddsktx_format_str(ddsktx_format format)
{
    return k__formats_info[format].name;
}

inline bool ddsktx_format_compressed(ddsktx_format format)
{
